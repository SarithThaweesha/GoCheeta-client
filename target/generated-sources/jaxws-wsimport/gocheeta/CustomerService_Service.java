 ...
 * 
 */
@WebServiceClient(name = "CustomerService", targetNamespace = "http://GoCheeta/", wsdlLocation = "http://localhost:8080/GoCheeta-service/CustomerService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CUSTOMERSERVICE_QNAME = new QName("http://GoCheeta/", "CustomerService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/GoCheeta-service/CustomerService?wsdl");
    ...
    public CustomerService getCustomerServicePort() {
        return super.getPort(new QName("http://GoCheeta/", "CustomerServicePort"), CustomerService.class);
    }
    ...
    public CustomerService getCustomerServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://GoCheeta/", "CustomerServicePort"), CustomerService.class, features);
    }
