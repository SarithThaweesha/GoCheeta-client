<%-- 
    Document   : KurunegalaBranch
    Created on : 15 Sep 2022, 20:55:40
    Author     : acer
--%>
...
<html>
    ...
    <body>
        ...
        if(name != null){
              ...
              Destination st = proxy.getDestinationK(name);
              id = st.getId();
              start=st.getStCity();
              name = st.getDestype();
        ...
        <section id="regform" class="section-p1">
            <div class="container2">
                <div class="contact-box2">
                    <div class="left3"><h4>Select Destination & Vehicle type from the drop down</h4><br><h2>Kurunegala Branch</h2></div>
            <div class="right2">
         <form  method="post">
            ...
            <input type="submit" formaction="KurunegalaBranch.jsp" class="btn" value="Get Journey Details"><br><br>
            ...
            <input type="submit" formaction="BookingServlet"  class="btn" value="Book Now"><br><br>
