<%-- 
    Document   : login
    Created on : 12 Sep 2022, 19:14:15
    Author     : acer
--%>
...
<html>
	...
	<div id="mobile2">
        ...
        <section id="logform" class="section-p2">
	    <div class="container">
	    <div class="contact-box">
	    <div class="left"></div>
	    <div class="right">
	<form name="registration_form" method="post" action="CustomerLoginServlet" onSubmit="return validate_form(); ">
	<h4> Login</h4>
	<label>
