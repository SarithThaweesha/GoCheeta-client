<%-- 
    Document   : KandyBranch
    Created on : 17 Sep 2022, 22:54:35
    Author     : acer
--%>
...
<html>
    ...
    <body>
        ...
        if(name != null){
              ...
              Destination st = proxy.getDestinationKandy(name);
              id = st.getId();
              start=st.getStCity();
              name = st.getDestype();
        ...
        <section id="regform" class="section-p1">
            <div class="container2">
                <div class="contact-box2">
                    <div class="left3"><h4>Select Destination & Vehicle type from the drop down</h4><br><h2>Kandy Branch</h2></div>
            <div class="right2">
         <form  method="post">
            ...
            <input type="submit" formaction="KandyBranch.jsp" class="btn" value="Get Journey Details"><br><br>
            ...
            <input type="submit" formaction="BookingKandyServlet"  class="btn" value="Book Now"><br><br>
