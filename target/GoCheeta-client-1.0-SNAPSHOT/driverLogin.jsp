<%-- 
    ...
    Created on : 18 Sep 2022, 15:16:41
    Author     : acer
--%>
...
<html>
    ...
    <body>
        ...
        <div>
            <ul id="navbar2">
                ...
                <li><a class="active" href="driverLogin.jsp">Driver Login</a></li>
	...
	<div id="mobile2">
	    ...
	    <div class="left"></div>
	    <div class="right">
	<form name="registration_form" method="post" action="DriverLoginServlet" onSubmit="return validate_form(); ">
	<h4>Driver Login</h4>
	<label>
