 ...
 * @author acer
 */
@WebServlet(name = "BookingGampahaServlet", urlPatterns = {"/BookingGampahaServlet"})
public class BookingGampahaServlet extends HttpServlet {
     ...
     */
     protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        response.sendRedirect("GampahaBranch.jsp");
    } 
  }