 ...
 * @author acer
 */
@WebServlet(name = "BookingJaffnaServlet", urlPatterns = {"/BookingJaffnaServlet"})
public class BookingJaffnaServlet extends HttpServlet {
     ...
     */
     protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        response.sendRedirect("JaffnaBranch.jsp");
    } 
  }