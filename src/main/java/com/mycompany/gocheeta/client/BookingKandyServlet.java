 ...
 * @author acer
 */
@WebServlet(name = "BookingKandyServlet", urlPatterns = {"/BookingKandyServlet"})
public class BookingKandyServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        response.sendRedirect("KandyBranch.jsp");
    } 
  }
