 ...
 * @author acer
 */
@WebServlet(name = "BookingGalleServlet", urlPatterns = {"/BookingGalleServlet"})
public class BookingGalleServlet extends HttpServlet {
   ...
   protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        response.sendRedirect("GalleBranch.jsp");
    } 
  }