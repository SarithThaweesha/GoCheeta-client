<%-- 
    Document   : JaffnaBranch
    Created on : 17 Sep 2022, 22:33:31
    Author     : acer
--%>
...
<html>
    <head>
        ...
        <title>Jaffna Branch Page</title>
    ...
    <body>
       ...
       <%
        ...
        if(name != null){
              ...
              Destination st = proxy.getDestinationJaffna(name);
              id = st.getId();
              start=st.getStCity();
              name = st.getDestype();
        ...
        <section id="regform" class="section-p1">
            <div class="container2">
                <div class="contact-box2">
                    <div class="left3"><h4>Select Destination & Vehicle type from the drop down</h4><br><h2>Jaffna Branch</h2></div>
            <div class="right2">
         <form  method="post">
            ...
            <input type="submit" formaction="JaffnaBranch.jsp" class="btn" value="Get Journey Details"><br><br>
            ...
            <input type="submit" formaction="BookingJaffnaServlet"  class="btn" value="Book Now"><br><br>
