<%-- 
    Document   : GampahaBranch
    Created on : 17 Sep 2022, 18:37:33
    Author     : acer
--%>
...
<html>
    <head>
        ...
        <title>Gampaha Branch Page</title>
    ...
    <body>
       <%
        ...
        if(name != null){
              ...
              Destination st = proxy.getDestinationGampaha(name);
              id = st.getId();
              start=st.getStCity();
              name = st.getDestype();
        ...
        <section id="regform" class="section-p1">
            <div class="container2">
                <div class="contact-box2">
                    <div class="left3"><h4>Select Destination & Vehicle type from the drop down</h4><br><h2>Gampaha Branch</h2></div>
            <div class="right2">
         <form  method="post">
            <label for="fname">Destination & Vehicle type</label>
            <select name="destype" id="category" class="dropc">
                <option>Nugegoda-Car</option>
                <option>Nugegoda-Van</option>
                <option>Nugegoda-Tuk</option>
                <option>Kurunegala-Car</option>
                <option>Kurunegala-Van</option>
                <option>Kurunegala-Tuk</option>
            ...
            <input type="submit" formaction="GampahaBranch.jsp" class="btn" value="Get Journey Details"><br><br>
            ...
            <input type="submit" formaction="BookingGampahaServlet"  class="btn" value="Book Now"><br><br>
